...
urlpatterns = [
    ...
    path('buyer/register/preview/', views.buyer_register_preview, name='buyer_register_preview'),
    path('buyer/register/submit/', views.buyer_register_submit, name='buyer_register_submit'),
